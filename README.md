...
**Current estimate for the code's release date: End of February 2016.**

**In the meantime, you may want to try a [Julia implementation](https://github.com/angel8yu/cpab-diffeo-julia) written by my student, Angel Yu. His implementation has far less options than the one I will post here (e.g, it is only in 1D or 2D) and doesn't use GPU.**
